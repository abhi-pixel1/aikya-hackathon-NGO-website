...
def ngolist():
    if request.method == 'POST':
        ...
        new_user= {"name":data["name"], "phno":data["phno"]}
        ...
        resp = client.send_message(
            message={
              ...
              "data":{
                "joke": "" + data["name"] + "has made a move to donate"+curr_details+"to your orphanage.\nto contact the donor phno:"+data["phno"]
